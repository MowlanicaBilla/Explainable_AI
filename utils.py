...
class DataLoader():
    ...
    def preprocess_data(self):
        # Convert 'True' to 1 and 'False' to 0 in the entire dataframe
        ...
        non_numeric_values = self.data.select_dtypes(exclude=['number'])
        if not non_numeric_values.empty:
            print("Non-numeric values found after preprocessing:")
